...
var JSONconfig = [{
  ...
  //START JSON CREATION
    ...
    ,"JSONcomediansPerPlayerMax" : 5 //max no of COMEDIANs to add to PLAYER
    //COMEDIANS
    ,"JSONcomediansToCreate" : 10 //how many new COMEDIANs to create in JSON
    //VENUE
    ,"JSONaudiencePerVenueMin" : 1 //min no of AUDIENCEs to associate with VENUE
    ,"JSONaudiencePerVenueMax" : 3 //max no of AUDIENCEs to associate with VENUE
  //END JSON CREATION
  ...
  //START ADD TO ATTRIBUTES WHEN ACTIONED
    //GIG
    // ,"gigComedianReputation" : 1 //add to COMEDIAN when GIG performed
    //SET
    // ,"setComedianReputation" : 0 //add to COMEDIAN when SET written
